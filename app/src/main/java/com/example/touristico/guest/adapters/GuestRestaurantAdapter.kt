...
class GuestRestaurantAdapter(private val list: MutableList<Restaurant>, private val context: Context) :
    RecyclerView.Adapter<GuestRestaurantAdapter.MyViewHolder>() {
