...
import com.example.touristico.databinding.FragmentAdminAddRestaurantBinding
...
class AdminAddRestaurantFragment : Fragment() {
    ...
    private var _binding: FragmentAdminAddRestaurantBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAdminAddRestaurantBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun initListeners() {
        ...
        binding.btnAdd.setOnClickListener {
            if (checkInput()) {
                ...
                hashMap["food"] = binding.etAttDesc.text.toString()
                hashMap["id"] = id
                hashMap["url"] = urlPicture

                databaseDevices.child("restaurants").push().setValue(hashMap)
                Toast.makeText(context, "Restaurant added successfully", Toast.LENGTH_LONG).show()
                Navigation.findNavController(requireView())
                    .navigate(R.id.action_adminAddRestaurantFragment_to_adminRestaurantsFragment)
            }
        }
